...
\begin{frame}{What Is an ADT?}
  ...
  \end{itemize}
  \vspace{0.1cm}
  \muted{An ADT has two parts: a declaration of data, and a declaration of operations
...
\begin{frame}{Week 1 Summary}
  \begin{itemize}
    ...
    \item The rest of this course is a tour of ADTs: contract first, implementation second.
  \end{itemize}
  \vspace{0.15cm}
