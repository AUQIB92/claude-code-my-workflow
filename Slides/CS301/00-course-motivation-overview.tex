...
\begin{frame}{One Small Story Through the Course}
  ...
  \end{itemize}
  \muted{Stacks, queues, lists, trees, and hash tables are exactly the structures
    every working programmer reaches for first
    \cite{Karumanchi2017_data_structures_algorithms_made_easy} --- and exactly
    the ones this course covers.}
\end{frame}
