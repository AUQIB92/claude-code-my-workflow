...
\noindent\textbf{Deadline:} \key{Tuesday, 25 August 2026, 11:59 PM} --- exactly \emph{two weeks} from issue (11 August 2026). Late submissions lose 10\% per day unless a documented excuse is provided in advance (see the course policy in the syllabus).
...
\begin{enumerate}
  ...
  \item[(c)] Explain what \textbf{cycle stealing} is, why it is a necessary consequence of DMA sharing the memory bus with the CPU, and what the CPU loses during the transfer.
\end{enumerate}
