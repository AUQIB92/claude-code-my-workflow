...
**Submission:** Assignments and lab work are submitted through the submission form linked from the [course page](https://auqib92.github.io/claude-code-my-workflow/courses/cs401/#submit). Submissions are timestamped on receipt; that timestamp is what the late-work rule below is applied to. Email submissions are not accepted.
